    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-indigo-950 to-slate-950 text-white select-none relative overflow-x-hidden flex flex-col justify-between">
      ...
      <header className="relative z-10 w-full max-w-6xl mx-auto px-4 pt-4 pb-2">
        ...
        <div className="flex items-center justify-between gap-2 mb-4">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-amber-300 font-black text-xs shadow-md"
          >
        ...
        <div className="mt-5 space-y-3">
          ...
          <div className="relative max-w-md mx-auto">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 rtl:pr-10 rtl:pl-4 py-2.5 rounded-2xl bg-slate-900/70 backdrop-blur-md border border-white/15 text-xs sm:text-sm text-white placeholder-slate-400 focus:outline-none focus:border-amber-400/60 transition-all shadow-inner"
            />
            {searchQuery && (
              <button
      ...
      <main className="relative z-10 w-full max-w-6xl mx-auto px-4 py-4 flex-1">
        {filteredGames.length === 0 ? (
          <div className="text-center py-12 px-4 rounded-3xl bg-slate-900/50 border border-white/10 backdrop-blur-md my-8">
              ...
              {filteredGames.map((game, index) => {
                ...
                return (
                  <motion.button
                    ...
                    className="group relative flex flex-col justify-between rounded-2xl sm:rounded-3xl bg-slate-900/80 backdrop-blur-md border border-white/15 hover:border-amber-400/60 shadow-lg hover:shadow-2xl hover:shadow-amber-500/10 overflow-hidden cursor-pointer text-right rtl:text-right transition-all duration-300"
                  >
                    ...
                    <div className="relative w-full aspect-square overflow-hidden bg-slate-950 rounded-t-2xl sm:rounded-t-3xl">
                      ...
                      <div className="absolute top-2.5 left-2.5 rtl:right-2.5 rtl:left-auto flex items-center gap-1 z-20">
                        {game.id === 'bee-hive-defense' ? (
                          ...
                          <span className="px-2 py-0.5 rounded-full bg-purple-600/90 backdrop-blur-md border border-purple-300/30 text-white font-extrabold text-[10px] sm:text-[11px] shadow-sm flex items-center gap-1">
                            <Bot className="w-3 h-3 text-purple-200" />
                            <span>VS AI</span>
                          </span>
                        ) : (
                          <span className="px-2 py-0.5 rounded-full bg-black/60 backdrop-blur-md border border-white/20 text-amber-200 font-extrabold text-[10px] sm:text-[11px] shadow-sm">
                            {game.badge.split(' ')[0]}
                          </span>
                        )}
                      </div>
